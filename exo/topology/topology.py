...
class Topology:
    def __init__(self):
        ...
        self.latency_matrix: Dict[Tuple[str, str], float] = {}  # Stores latency between node pairs
    ...
    def set_latency(self, node1_id: str, node2_id: str, latency: float):
        self.latency_matrix[(node1_id, node2_id)] = latency
        self.latency_matrix[(node2_id, node1_id)] = latency

    def get_latency(self, node1_id: str, node2_id: str) -> float:
        return self.latency_matrix.get((node1_id, node2_id), 0.0)
    ...
    def merge(self, other: "Topology"):
        ...
        self.latency_matrix.update(other.latency_matrix)
